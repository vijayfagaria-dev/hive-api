"""NFC spots — static content config for the `/api/spots/<spot>` pages.

Each spot maps to a title, emoji, and an optional rule-category PRE-FILTER (tap
the kitchen sticker -> only kitchen rules). `shame` flips the living-room
"control room" into the Hall-of-Shame view. Category values match seed categories.
"""
